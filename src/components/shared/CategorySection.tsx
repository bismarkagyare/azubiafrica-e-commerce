...
const CategoryCard = ({ name, image, alt }: { name: string; image: string; alt: string }) => (
  <div className="relative flex flex-col items-center bg-neutral-100 rounded-xl pt-16 pb-8 px-6 shadow-sm w-full max-w-xs mx-auto overflow-visible">
    <img
      src={image}
      alt={alt}
      className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/3 w-32 h-32 object-contain drop-shadow-lg select-none pointer-events-none"
      draggable={false}
      style={{ zIndex: 1 }}
    />
