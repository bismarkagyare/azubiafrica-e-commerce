...
const RelatedProducts: FC<RelatedProductsSectionProps> = ({
  others,
  category,
}) => {
        ...
        {others.map((item) => (
          ...
          >
            ...
            <button
              ...
              className="bg-primary-orangeish hover:bg-primary-orangeish/80 text-white font-bold uppercase tracking-widest px-8 py-4 text-base transition-colors duration-150 cursor-pointer"
              type="button"
            >
              See Product
            </button>
